...
# Import functions from train_job script
...
if __name__ == '__main__':
    ...
    parser.add_argument('--max_level', type=int, default=17, help='maximum number of tables and aliases used in joins, for JOB this is 17 (template 29)')
